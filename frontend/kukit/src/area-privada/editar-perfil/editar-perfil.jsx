              ...
              <form onSubmit={manejarEnvio}>
                ...
                <div className="info-perfil">
                  <div className="contenedores-info-perfil">
                    ...
                    <p id="correo" name="correo" className="correo-display-perfil" style={{ padding: '10px', border: '1px solid #ccc', borderRadius: '4px', backgroundColor: '#f0f0f0', width: '95%' }}>{formData.correo}</p>
                  </div>
                </div>
